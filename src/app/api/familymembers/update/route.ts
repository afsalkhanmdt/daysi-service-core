...
export async function POST(
    ...
    return Response.json({
        ...
        ResourceUrl: "https://api.daysi.dk/DaysiImages/DefaultFamilyAdmin.png",
        Events: [],
        Birthdate: null,
        ...
        Frequency: 0,
        Counter: 0,
        ExportEventUrl: "https://api.daysi.dk/api/FamilyMembers/GetDaysiEvents?token=Sfzj7kx33Ug12HklBziYTrNW9my%2fFVKU",
