...
const calendarView = () => {
  ...
  return (
    <div className="p-4 bg-slate-100 flex flex-col gap-4 h-full rounded-2xl">
      <div className="bg-white p-4 rounded-2xl gap-6 grid ">
        {/* Month Navigation with Today */}
        <div className="w-full md:flex md:justify-between grid gap-2 place-items-center ">
          ...
          <div className=" grid place-items-center sm:flex sm:items-center gap-2">
            <button
              onClick={handleToday}
              className="ml-4 px-5 py-2 rounded-xl bg-emerald-400 text-white hover:bg-emerald-600 text-lg font-semibold"
            >
              Today
            </button>
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-5 py-2 text-lg font-semibold rounded-lg bg-slate-100 text-zinc-600 hover:bg-slate-300"
              >
                &lt;
              </button>
