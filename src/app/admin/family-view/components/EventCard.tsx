  ...
  return (
    <div className="flex flex-col sm:gap-1 p-1 h-full">
      <div className="flex justify-between items-center">
        {isUploading ? (
          <div className="flex items-center gap-1 py-0.5 px-1.5 sm:py-1 sm:px-2 bg-amber-50 text-amber-700 border border-amber-200/90 rounded-full text-[8px] sm:text-[10px] font-semibold animate-pulse shadow-2xs">
            <svg
              className="w-2.5 h-2.5 sm:w-3 sm:h-3 animate-spin text-amber-600 shrink-0"
              fill="none"
              viewBox="0 0 24 24"
            >
              <circle
          ...
          <div className="text-center py-0.5 px-1.5 sm:py-1 sm:px-2 bg-indigo-50 text-sky-500 w-fit text-[7px] sm:text-xs rounded-2xl font-medium">
            {t("Event")}
          </div>
        )}
